...
public class DrillBlockEntityRenderer implements BlockEntityRenderer<DrillBlockEntity> {
    ...
    public void render(DrillBlockEntity be, float partialTick, PoseStack pose,
        ...
        // 2×2 平面 quad（-1..1），uv 覆盖整张 rotator 图，法线朝上喵
        vc.addVertex(matrix, -1f, 0f, -1f).setUv(0f, 0f).setColor(255, 255, 255, 255).setLight(light).setOverlay(overlay).setNormal(0f, 1f, 0f);
        vc.addVertex(matrix, -1f, 0f, 1f).setUv(0f, 1f).setColor(255, 255, 255, 255).setLight(light).setOverlay(overlay).setNormal(0f, 1f, 0f);
        vc.addVertex(matrix, 1f, 0f, 1f).setUv(1f, 1f).setColor(255, 255, 255, 255).setLight(light).setOverlay(overlay).setNormal(0f, 1f, 0f);
        vc.addVertex(matrix, 1f, 0f, -1f).setUv(1f, 0f).setColor(255, 255, 255, 255).setLight(light).setOverlay(overlay).setNormal(0f, 1f, 0f);
        pose.popPose();
    }
}
