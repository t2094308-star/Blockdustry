...
- [x] 方块血量系统（前置库）
- [x] 队伍系统（Mindustry 原作队伍 + 调试棒 UI）
- [x] 建筑系统（机械钻头 2×2 挖矿、duo 双管炮、多格高亮框）
- [x] 物流系统（传送带 + Router 物品传递）
...
`docs/` 目录存放对 Mindustry 原版机制的探索笔记（单位工厂、电力系统、三维物流等），供后续移植参考。
